...
def sms_reply():
    ...
    '''
            ...
            resp.message(reply)
            text = 'To request a movie, just use the command _*Get Movie Name*_, to get a nollywood movie use _*Get Nolly Movie Name*_'
            resp.message(text)

        if 'message' not in str(resp).lower():
            text = 'I am sorry, something went wrong!' + '\n\n' + 'To request a movie, just use the command _*Get Movie Name*_, to get a nollywood movie use _*Get Nolly Movie Name*_'
            resp.message(text)
